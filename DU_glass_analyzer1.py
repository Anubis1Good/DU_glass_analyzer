...
while True:
    ...
    table_1hour = get_table_for_period(df1, minutes=60, count_threshold=COUNT_THRESHOLD, top_n=TOP_N)
    table_8hour = get_table_for_period(df1, minutes=60*8, count_threshold=COUNT_THRESHOLD, top_n=TOP_N)

    table_10min2 = get_table_for_period(df2, minutes=10, count_threshold=COUNT_THRESHOLD, top_n=TOP_N)
    table_1hour2 = get_table_for_period(df2, minutes=60, count_threshold=COUNT_THRESHOLD, top_n=TOP_N)
